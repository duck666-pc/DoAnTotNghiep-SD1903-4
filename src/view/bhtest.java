 ...
 * @author Admin
 */
public class bhtest extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bhtest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
